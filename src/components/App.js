...
// define one block
// define the combination of blocks
// define actions in the game with status in it
// combine the combination of blocks and the actions in the game 
...
const reducer = (state, action) => {
  ...
  switch (action.type) {
    ...
    case 'CLICK': {
      ...
      // state helps form grid; state helps form turn with the help of grid
      const { grid, turn } = state

      // making sure state is not turn
      if (grid[y][x]) {
        return state
      }
      ...
      // you must make the index of NEXT_TURN: an object of state, but the cloned state
...
function Game() {
  ...
  // use dispatch if there are series of function manipulations or if statements
